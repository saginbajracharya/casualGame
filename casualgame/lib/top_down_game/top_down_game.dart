...
import 'package:casualgame/top_down_game/robot_enemy.dart';
import 'package:casualgame/top_down_game/soldier_player.dart';
...
class TopDownGame extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BonfireTiledWidget(
      ...
      lightingColorGame: Colors.blue.withOpacity(0.2),
    );
  }
}
